...
export const AUDIT_ACTIONS = {
  ...
  JOB_JD_IMPROVE_REQUESTED: 'JOB_JD_IMPROVE_REQUESTED',
  JOB_JD_IMPROVE_COMPLETED: 'JOB_JD_IMPROVE_COMPLETED',
  JOB_JD_IMPROVE_FAILED: 'JOB_JD_IMPROVE_FAILED',
  JOB_JD_REFINE_REQUESTED: 'JOB_JD_REFINE_REQUESTED',
  JOB_JD_REFINE_COMPLETED: 'JOB_JD_REFINE_COMPLETED',
  JOB_JD_REFINE_FAILED: 'JOB_JD_REFINE_FAILED',
  JOB_JD_SUGGESTION_APPLIED: 'JOB_JD_SUGGESTION_APPLIED',
  JOB_JD_UPDATED: 'JOB_JD_UPDATED',
  JOB_INTERVIEW_KIT_REQUESTED: 'JOB_INTERVIEW_KIT_REQUESTED',
  JOB_INTERVIEW_KIT_COMPLETED: 'JOB_INTERVIEW_KIT_COMPLETED',
  JOB_INTERVIEW_KIT_FAILED: 'JOB_INTERVIEW_KIT_FAILED',
  ...
  CANDIDATE_ASSIGNED_TO_JOB: 'CANDIDATE_ASSIGNED_TO_JOB',
